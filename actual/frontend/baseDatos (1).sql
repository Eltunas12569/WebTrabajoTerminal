...
--
-- Current Database: `sistema_tt`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `sistema_tt` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;

USE `sistema_tt`;

--
-- Table structure for table `asistencias_eventos`
--

DROP TABLE IF EXISTS `asistencias_eventos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `asistencias_eventos` (
  ...
  CONSTRAINT `asistencias_eventos_ibfk_1` FOREIGN KEY (`evento_id`) REFERENCES `eventos_club` (`id`) ON DELETE CASCADE,
  CONSTRAINT `asistencias_eventos_ibfk_2` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE
...
CREATE TABLE `avisos` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_avisos_c_clubes` (`club_id`),
  KEY `fk_avisos_c_usuarios` (`usuario_id`),
  CONSTRAINT `fk_avisos_c_clubes` FOREIGN KEY (`club_id`) REFERENCES `clubes` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_avisos_c_usuarios` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `chat_mensajes` (
  ...
  `club_id` int DEFAULT NULL,
  `tipo_sala` enum('club','directivos','encargados') NOT NULL,
  `mensaje` text NOT NULL,
  `fecha_envio` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `usuario_id` (`usuario_id`),
  KEY `club_id` (`club_id`),
  CONSTRAINT `chat_mensajes_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE SET NULL,
  CONSTRAINT `chat_mensajes_ibfk_2` FOREIGN KEY (`club_id`) REFERENCES `clubes` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `clubes` (
  ...
  `codigo_union` varchar(10) DEFAULT NULL,
  ...
  `motivo_rechazo` text,
  PRIMARY KEY (`id`),
  UNIQUE KEY `codigo_union` (`codigo_union`),
  KEY `idx_clubes_estatus` (`estatus`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `contactos_emergencia` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_contactos_usuarios` (`usuario_id`),
  CONSTRAINT `fk_contactos_usuarios` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `eventos_club`
--

DROP TABLE IF EXISTS `eventos_club`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `eventos_club` (
  ...
  KEY `club_id` (`club_id`),
  KEY `usuario_id` (`usuario_id`),
  CONSTRAINT `eventos_club_ibfk_1` FOREIGN KEY (`club_id`) REFERENCES `clubes` (`id`) ON DELETE CASCADE,
  CONSTRAINT `eventos_club_ibfk_2` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `historial_encargados`
--

DROP TABLE IF EXISTS `historial_encargados`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `historial_encargados` (
  ...
  `club_id` int NOT NULL,
  `usuario_id` int NOT NULL,
  `rol_desempenado` enum('encargado_alumno','encargado_profesor') DEFAULT NULL,
  `fecha_inicio` datetime DEFAULT CURRENT_TIMESTAMP,
  `fecha_fin` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_historial_club` (`club_id`),
  KEY `fk_historial_usuario` (`usuario_id`),
  CONSTRAINT `fk_historial_club` FOREIGN KEY (`club_id`) REFERENCES `clubes` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `inscripciones` (
  ...
  KEY `idx_inscripciones_club_estatus` (`club_id`,`estatus`),
  CONSTRAINT `fk_insc_clubes` FOREIGN KEY (`club_id`) REFERENCES `clubes` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_insc_usuarios` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_inscripciones_update` AFTER UPDATE ON `inscripciones` FOR EACH ROW BEGIN
    -- Si deja el cargo, se registra su fecha de fin
    IF OLD.rol_en_club IN ('encargado_profesor', 'encargado_alumno') AND NEW.rol_en_club = 'miembro' THEN
        UPDATE historial_encargados 
        SET fecha_fin = NOW() 
        WHERE club_id = OLD.club_id AND usuario_id = OLD.usuario_id AND rol_desempenado = OLD.rol_en_club AND fecha_fin IS NULL;
    END IF;

    -- Si toma el cargo, se crea un nuevo registro
    IF OLD.rol_en_club = 'miembro' AND NEW.rol_en_club IN ('encargado_profesor', 'encargado_alumno') THEN
        INSERT INTO historial_encargados (club_id, usuario_id, rol_desempenado, fecha_inicio)
        VALUES (NEW.club_id, NEW.usuario_id, NEW.rol_en_club, NOW());
    END IF;
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_auditoria_encargados_update` AFTER UPDATE ON `inscripciones` FOR EACH ROW BEGIN
    IF OLD.rol_en_club IN ('encargado_profesor', 'encargado_alumno') AND NEW.rol_en_club = 'miembro' THEN
        INSERT INTO historial_encargados (club_id, usuario_id, rol_desempenado, fecha_inicio, fecha_fin)
        VALUES (OLD.club_id, OLD.usuario_id, OLD.rol_en_club, OLD.fecha_inscripcion, NOW());
    END IF;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
CREATE TABLE `usuarios` (
  ...
  `expiracion_otp` datetime DEFAULT NULL,
  `eliminado` tinyint(1) NOT NULL DEFAULT '0',
  `acepta_privacidad` tinyint(1) NOT NULL DEFAULT '0',
  `version_aviso_privacidad` varchar(20) DEFAULT NULL,
  ...
  KEY `fk_usuarios_roles` (`role_id`),
  CONSTRAINT `fk_usuarios_roles` FOREIGN KEY (`role_id`) REFERENCES `roles` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-09-20 21:38:17
